...
const Footer = () => {
    return (
        <footer aria-label="Site Footer" className="bg-green-200 dark:bg-black">
            <div className="mx-auto max-w-screen-xl px-4 pb-8 pt-16 sm:px-6 lg:px-8">
                ...
                <div className="mt-16 grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-32">
                    <div className="mx-auto max-w-sm lg:max-w-none">
                        <p className="mt-4 text-center text-gray-500 lg:text-left lg:text-lg">"Throughout our program, skilled instructors will lead you in methodical lessons, fostering a strong base while encouraging your artistic flair and musical interpretation."</p>
                ...
                <div className="mt-16 border-t border-gray-100 pt-8">
                    <p className="text-center text-xs/relaxed text-gray-500">
                        ...
                        Created with &nbsp;
                        <a className="text-secondary dark: underline transition hover:text-secondary dark:/75">Have-A-Relax</a>
                    </p>
                </div>
            </div>
        </footer>
